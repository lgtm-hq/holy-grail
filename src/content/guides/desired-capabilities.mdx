...
> Since Appium 2.x, capabilities follow the
...
Appium provides Options classes that handle vendor prefixing automatically.
...
```python
# legacy format (Appium 1.x) -- will not work
caps = {
    "platformName": "Android",

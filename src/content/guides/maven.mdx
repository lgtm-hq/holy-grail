...
> Writing to the JVM keystore at `$JAVA_HOME/lib/security/cacerts` typically requires elevated privileges. If you see a "permission denied" error, ensure you prefix the `keytool` command with `sudo`.
